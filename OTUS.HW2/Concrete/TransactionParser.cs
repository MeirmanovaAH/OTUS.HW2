...
namespace OTUS.HW2.Concrete
{
    public class TransactionParser : ITransactionParser
    {
        ...
        public ITransaction Parse(string input)
        {
            ...
            {
                throw new ArgumentException(nameof(input), "Необходимо ввести данные!");
            }
            ...
            {
                throw new ArgumentException(nameof(input), $"Ввод данных неверный. Запрос должен состоять из {wordsMinCount} слов.");
            }
